    ...
    while (processes_finished < num_processes)
    {
        ...
        if (running_process)
        {
            ...
            else // Caso normal
            {
                ...
                printf("%s: n_bursts: %d ; remaining_burst: %d; quantum: %d\n", running_process->name, running_process->n_bursts, running_process->remaining_burst, running_process->quantum);
            }
        }
